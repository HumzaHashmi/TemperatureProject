...
////////////////////////////////////////////////////////////////////////////////
	/*Problem 7*/
	printf("\n\n**QUESTION 7**");
	daysToSwim(sup, mich, huron, erie, ont, st_clr);//call days able to swim function
	
	/*Problem 8*/
	printf("\n\n**QUESTION 8**");
	frozen(sup, mich, huron, erie, ont, st_clr);//call days frozen function
...
////////////////////////////Question 9///////////////////////////////////////////////////////
	...
	for(int i=0;i<MAX;i++)
	{
		sup2_total= (sup2_total +sup2[i]);
	}
	sup2_avg = (sup2_total)/365;
	 
	printf("\n");
	printf("The yearly average temperature in 2019 for Lake Superior is %7.2lf degrees.\n", sup2_avg);
	
	// yearly avg for mich
	double mich2_avg;
	double mich2_total=0;
	// for loop that adds up all the temperatures and puts it into one variable
	for(int i=0;i<MAX;i++)
	{
		mich2_total= (mich2_total +mich2[i]);
	}
	mich2_avg = (mich2_total)/365;
	
	printf("\n");
	printf("The yearly average temperature in 2019 for Lake Michigan is %7.2lf degrees.\n", mich2_avg);
	
	// yearly avg for huron
	double huron2_avg;
	double huron2_total=0;
	// for loop that adds up all the temperatures and puts it into one variable
	for(int i=0;i<MAX;i++)
	{
		huron2_total= (huron2_total +huron2[i]);
	}
	huron2_avg = (huron2_total)/365;
	 
	printf("\n");
	printf("The yearly average temperature in 2019 for Lake Huron is %7.2lf degrees.\n", huron2_avg);
	
	// yearly avg for Erie
	double erie2_avg;
	double erie2_total=0;
	// for loop that adds up all the temperatures and puts it into one variable
	for(int i=0;i<MAX;i++)
	{
		erie2_total= (erie2_total +erie2[i]);
	}
	erie2_avg = (erie2_total)/365;
	
	printf("\n");
	printf("The yearly average temperature in 2019 for Lake Erie is %7.2lf degrees.\n", erie2_avg);
	...
	for(int i=0;i<MAX;i++)
	{
		ont2_total= (ont2_total +ont2[i]);
	}
	ont2_avg = (ont2_total)/365;
	
	printf("\n");
	printf("The yearly average temperature in 2019 for Lake Ontario is %7.2lf degrees.\n", ont2_avg);
	
	
	// yearly avg for st_clr
	double st_clr2_avg;
	double st_clr2_total=0;
	// for loop that adds up all the temperatures and puts it into one variable
		for(int i=0;i<MAX;i++)
	{
		st_clr2_total= (st_clr2_total +st_clr2[i]);
	}
	st_clr2_avg = (st_clr2_total)/365;
	 
	printf("\n");
	printf("The yearly average temperature in 2019 for Lake St. Clair is %7.2lf degrees.\n", st_clr2_avg);
	
	// the average of all the lakes combined(using each yearly avg)
	double combined2_avg;
	//combines all avgs and devides by 6 to calc new avg
	combined2_avg= (st_clr2_avg + ont2_avg + erie2_avg + mich2_avg + huron2_avg + sup2_avg)/6;
	
	//prints results
	printf("\nThe yearly average for all six lakes put together in 2019 is %7.2lf degrees.\n", combined2_avg);
	
	fclose(file); 
	
	//mich_avg > st_clr_avg && mich_avg > ont_avg && mich_avg > erie_avg && mich_avg > huron_avg && mich_avg > sup_avg)
	////creating a table comparing results//////
	printf("\n\n\n");
	printf("Year    Ontario    Erie    Huron    Michigan    Superior    St.Clair\n"); 
	printf("2020    %.2lf     %.2lf     %.2lf     %.2lf       %.2lf       %.2lf \n", ont_avg, erie_avg, huron_avg, mich_avg, sup_avg, st_clr_avg);  
	printf("2019    %.2lf      %.2lf     %.2lf     %.2lf        %.2lf       %.2lf \n", ont2_avg, erie2_avg, huron2_avg, mich2_avg, sup2_avg, st_clr2_avg);	
